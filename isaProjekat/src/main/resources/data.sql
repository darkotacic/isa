...
insert into grade(grd_id, grd_meal, grd_res, grd_service, guest_user_id, order_res_ord_id, restaurant_res_id) values (1, 3, 5, 2, 1, 3, 1);
insert into grade(grd_id, grd_meal, grd_res, grd_service, guest_user_id, order_res_ord_id, restaurant_res_id) values (2, 4, 5, 8, 2, 3, 1);
insert into grade(grd_id, grd_meal, grd_res, grd_service, guest_user_id, order_res_ord_id, restaurant_res_id) values (3, 9, 5, 8, 13, 4, 1);
